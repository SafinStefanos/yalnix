...
#define MIN_PMEM_SIZE  VMEM_REGION_SIZE
#define MAX_PMEM_SIZE  (16*VMEM_SIZE)
#define DEFAULT_PMEM_SIZE               2*VMEM_SIZE
...
typedef struct PCB {
  ...
  int state;
  int exstat;
  int kstack_pfn[2]; /* standard stack 2 pages */
  int init;
...
// handy debug tools
#ifndef ENTER
#define ENTER TracePrintf(3,"entering %s\n", __func__)
#endif


#ifndef LEAVE
#define LEAVE TracePrintf(3,"leaving %s\n", __func__)
#endif
